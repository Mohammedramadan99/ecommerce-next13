        ...
        <>
          <div className="container">
            ...
            <div className="productDetails__right" data-aos="fade-left">
              <div className="productDetails__right__name">
                {" "}
                {product?.name}{" "}
              </div>
              <div className="productDetails__right__rating">
                ...
                <div className="productDetails__right__rating__reviewsNum">
                  {" "}
                  {product?.numOfReviews < 1 || product?.numOfReviews === 1
              ...
              <div className="productDetails__right__quantity">
                <div
                  className="productDetails__right__quantity__icon"
              ...
              <div className="productDetails__right__btns">
                <div
                  className="productDetails__right__btns__btn main__btn"
                  onClick={addToCartHandler}
                >
                  add to cart
                </div>
                <div
                  className="productDetails__right__btns__btn "
        ...
        <div className="container">
          <div className="productDetails__bottom__relatedPoriductsSection">
            ...
            <div className="productDetails__bottom__relatedPoriductsSection__products">
              <ProductsSlider category={product?.category} />
            </div>
          </div>
          <div className="productDetails__bottom__reviewsSection">
            <div className="productDetails__bottom__reviewsSection__bar">
              <div
                className={`productDetails__bottom__reviewsSection__bar__link ${
                  barActive === "description" ? "active" : ""
                }`}
                onClick={(e) => setBarActive("description")}
              >
                description
              </div>
              <div
                className={`productDetails__bottom__reviewsSection__bar__link ${
                  barActive === "reviews" ? "active" : ""
                }`}
                onClick={(e) => setBarActive("reviews")}
              >
                {" "}
                reviews{" "}
              </div>
              ...
              barActive === "reviews" && (
                <div className="productDetails__bottom__reviewsSection__reviews zoomOut_animation">
                  ...
                  <div className="productDetails__bottom__reviewsSection__reviews__ratingNum">
                    <div className="productDetails__bottom__reviewsSection__reviews__ratingNum__num">
                      {" "}
                      <span> {product?.ratings.toFixed(1)} </span> out of{" "}
                      <span> 5 </span>{" "}
                    </div>
                  ...
                  <div className="productDetails__bottom__reviewsSection__reviews__items">
                    {product?.reviews.map((rev) => (
                      <div
                        key={rev._id}
                        className="productDetails__bottom__reviewsSection__reviews__items__item"
                      >
                        <div className="productDetails__bottom__reviewsSection__reviews__items__item__img">
                          {rev?.user?.personalImage?.url && (
                            <Image
                              src={rev?.user?.personalImage?.url}
                              layout="fill"
                              objectFit="contain"
                              alt="img"
                            />
