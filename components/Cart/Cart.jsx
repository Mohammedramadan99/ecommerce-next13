...
function Cart() {
  ...
  return (
    <div className="cart">
      <div className="cart__overlay" onClick={showCartHandler}></div>
      <div className="cart__wrapper">
            ...
            {products?.map((p) => (
              <div key={p._id} className="cart__wrapper__products__product">
                <div className="cart__wrapper__products__product__img">
                  ...
                  <div className="cart__wrapper__products__product__img__quantity">
                    {" "}
                    {p.quantity}X{" "}
                  </div>
                </div>
                <div className="cart__wrapper__products__product__details">
                  <div className="cart__wrapper__products__product__details__name">
                    {" "}
                    {p.name}{" "}
                  </div>
                  <div className="cart__wrapper__products__product__details__category">
                    {" "}
                    {p.category}{" "}
                  </div>
                  <div className="cart__wrapper__products__product__details__price">
                    {" "}
                    ${p.price}{" "}
                  </div>
                </div>
                <CloseIcon
                  className="cart__wrapper__products__product__delete"
        ...
        <div className="cart__wrapper__priceContent">
          <div className="cart__wrapper__priceContent__price">
            ...
            <div className="cart__wrapper__priceContent__price__number">
              {" "}
              ${total}{" "}
            </div>
          </div>
          ...
          <Link
            href="/checkout"
            className="cart__wrapper__priceContent__checkoutBtn"
          >
            checkout
          </Link>
        </div>
