...
function Banner() {
  ...
  const bannerImg = allProducts?.find(
    (p) => p._id === "635a4b340dd49b3e0493dc85"
  )?.images[0]?.url;
      ...
      <div className="container">
        <div className="banner__content">
          ...
          <div className="banner__content__img" data-aos="zoom-in-up">
            <Image
              src="https://res.cloudinary.com/dtmjc8y9z/image/upload/v1668378317/ecommerce/dholtwz8jgnwj9tgkams.png"
              layout="fill"
              objectFit="contain"
              alt="bannerImg"
            />
